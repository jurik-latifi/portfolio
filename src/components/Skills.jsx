  ...
  },
  {
    ...
    icon: (
      <>
        ...
        <FaHtml5 className="text-orange-500 ml-2" />
      </>
    ),
    type: "experience",
  },
...
const Skills = () => {
  ...
  return (
    <section
      id="skills"
      className="py-20 bg-primary text-text px-4 sm:px-6 lg:px-0"
    >
        ...
        <div>
          ...
          <div className="space-y-4">
            {experienceSkills.map((skill, i) => (
              <div
                key={i}
                className="flex items-center p-4 bg-gradient-to-r from-purple-500 via-pink-500 to-yellow-400 text-white rounded-xl shadow-lg hover:scale-105 transition-transform"
              >
        ...
        <div>
          ...
          <div className="space-y-4">
            {academicSkills.map((skill, i) => (
              <div
                key={i}
                className="flex items-center p-4 bg-gray-700 text-white rounded-xl shadow-md hover:scale-105 transition-transform opacity-80"
              >
                <div className="mr-4 text-2xl">{skill.icon}</div>
                <span className="font-semibold text-lg">{skill.name}</span>
              </div>
